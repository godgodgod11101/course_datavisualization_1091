...
chosenYear=2017
options(rstudio_drake_cache = storr::storr_rds("D:/Users/User/Documents/GitHub/course_datavisualization_1091/20201014_dp/.taiwanXMGDPRatio", hash_algorithm = "xxhash64"))
...
world_import = {
  ...
  world_import %=% WDI(country = c("US", "CA", "MX"), indicator = import_search[12, 1])
  world_import
},
...
world_export = {
  ...
  world_export %=% WDI(country = c("US", "CA", "MX"), indicator = export_search[13, 1])
  world_export
},
...
cache=drake::drake_cache(
  path="D:/Users/User/Documents/GitHub/course_datavisualization_1091/20201014_dp/.taiwanXMGDPRatio"),...)
}
...
drake::loadd(...,
cache=drake::drake_cache(
  path="D:/Users/User/Documents/GitHub/course_datavisualization_1091/20201014_dp/.taiwanXMGDPRatio"), envir = .GlobalEnv)
}
